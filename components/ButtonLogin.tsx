...
function ButtonLogin({ text, icon }: ButtonLoginProps) {
    return (
        <button onClick={() => signIn("google")} className="self-stretch  px-5 py-3 bg-black rounded-xl border border-[#e3e2e4] flex-col justify-start items-start gap-2.5 flex">
