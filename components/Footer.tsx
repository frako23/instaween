...
const Footer = () => {
  return (
    <div className="h-20 px-2 bg-pumpkinOrange justify-center items-start gap-2 inline-flex w-full">
      <div className=" shrink basis-0 h-20 py-4 justify-center items-center gap-1 flex">
      ...
      <div className=" shrink basis-0 h-20 py-3 flex-col justify-center items-center gap-1 inline-flex">
